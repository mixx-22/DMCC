...
const SchedulePageContent = () => {
  ...
  const generateScheduleHTML = () => {
    ...
    const formatVisitRange = (visit, index) => {
      const startDate = visit?.date?.start ?? visit?.date;
      const endDate = visit?.date?.end;
        ...
        <body>
          ...
          <table class="organizations-table">
            ...
            <tr>
              ...
              <td>
                ${
                  org?.visits && org.visits.length > 0
                    ? `<ul class="visit-list">${org.visits
                        .map(
                          (visit, visitIndex) =>
                            `<li>${formatVisitRange(visit, visitIndex)}</li>`,
                        )
                        .join("")}</ul>`
                    : "No visits scheduled"
                }
